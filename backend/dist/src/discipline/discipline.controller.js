...
const create_discipline_incident_dto_1 = require("./dto/create-discipline-incident.dto");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_discipline_incident_dto_1.CreateDisciplineIncidentDto]),
    __metadata("design:returntype", void 0)
...
exports.DisciplineController = DisciplineController = __decorate([
    (0, common_1.Controller)("discipline-incidents"),
    (0, audit_decorator_1.Audit)("DisciplineIncident"),
    (0, resource_decorator_1.Resource)("discipline"),
