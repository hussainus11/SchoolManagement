...
exports.HomeworkModule = HomeworkModule = __decorate([
    (0, common_1.Module)({
        controllers: [assignment_controller_1.AssignmentController, submission_controller_1.SubmissionController],
        providers: [assignment_service_1.AssignmentService, submission_service_1.SubmissionService]
    })
], HomeworkModule);
