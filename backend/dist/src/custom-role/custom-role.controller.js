...
let CustomRoleController = class CustomRoleController {
    customRoleService;
    constructor(customRoleService) {
        this.customRoleService = customRoleService;
    }
    getCatalog() {
        return resource_catalog_1.RESOURCE_CATALOG;
    }
    findAll(user) {
...
], CustomRoleController.prototype, "getCatalog", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __metadata("design:returntype", void 0)
], CustomRoleController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(":id"),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    ...
    __metadata("design:returntype", void 0)
], CustomRoleController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    ...
    __metadata("design:returntype", void 0)
], CustomRoleController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(":id"),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)("id")),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, update_custom_role_dto_1.UpdateCustomRoleDto]),
    __metadata("design:returntype", void 0)
], CustomRoleController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], CustomRoleController.prototype, "remove", null);
exports.CustomRoleController = CustomRoleController = __decorate([
    (0, common_1.Controller)("custom-roles"),
    (0, audit_decorator_1.Audit)("CustomRole"),
    (0, roles_decorator_1.Roles)(client_1.Role.SCHOOL_ADMIN, client_1.Role.BRANCH_ADMIN),
    __metadata("design:paramtypes", [custom_role_service_1.CustomRoleService])
], CustomRoleController);
//# sourceMappingURL=custom-role.controller.js.map