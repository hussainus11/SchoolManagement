...
exports.LibraryModule = LibraryModule = __decorate([
    (0, common_1.Module)({
        controllers: [book_controller_1.BookController, book_issue_controller_1.BookIssueController],
        providers: [book_service_1.BookService, book_issue_service_1.BookIssueService]
    })
], LibraryModule);
