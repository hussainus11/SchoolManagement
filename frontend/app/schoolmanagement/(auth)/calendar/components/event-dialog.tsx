...
import type { CalendarEvent, SchoolEventType } from "./";
import { EVENT_TYPE_COLOR, EVENT_TYPE_LABEL } from "./";
...
export function EventDialog({ event, isOpen, onClose, onSave, onDelete }: EventDialogProps) {
  ...
  const [type, setType] = useState<SchoolEventType>("OTHER");
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="*:not-first:mt-1.5">
            ...
            <Select value={type} onValueChange={(value: SchoolEventType) => setType(value)}>
              <SelectTrigger id="event-type" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {(Object.keys(EVENT_TYPE_LABEL) as SchoolEventType[]).map((value) => (
