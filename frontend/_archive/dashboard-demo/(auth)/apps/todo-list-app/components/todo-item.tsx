...
import { priorityClasses, statusClasses } from "@/app/schoolmanagement/(auth)/apps/todo-list-app/enum";
import { Todo, TodoStatus } from "@/app/schoolmanagement/(auth)/apps/todo-list-app/types";
