...
import useChatStore from "@/app/schoolmanagement/(auth)/apps/chat/useChatStore";
import { ChatItemProps } from "@/app/schoolmanagement/(auth)/apps/chat/types";

import { Input } from "@/components/ui/input";
import { ChatListItem } from "@/app/schoolmanagement/(auth)/apps/chat/components/chat-list-item";
import {
  Card,
  CardAction,
  CardContent,
...
import { ActionDropdown } from "@/app/schoolmanagement/(auth)/apps/chat/components/action-dropdown";
