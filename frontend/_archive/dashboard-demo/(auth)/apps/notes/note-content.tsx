...
import { AddNoteModal } from "@/app/schoolmanagement/(auth)/apps/notes/add-note-modal";
import { Note } from "@/app/schoolmanagement/(auth)/apps/notes/types";
import NoteListItem from "@/app/schoolmanagement/(auth)/apps/notes/note-list-item";
import { notes } from "@/app/schoolmanagement/(auth)/apps/notes/data";
import { NoteMobileSidebar } from "@/app/schoolmanagement/(auth)/apps/notes/note-sidebar";
