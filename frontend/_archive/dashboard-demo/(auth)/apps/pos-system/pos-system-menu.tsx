...
import {
  ...
  Table,
  TableCategory
} from "@/app/schoolmanagement/(auth)/apps/pos-system/store";

import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { RadioGroup } from "@/components/ui/radio-group";
import ProductListItem from "@/app/schoolmanagement/(auth)/apps/pos-system/components/product-list-item";
import AddProductDialog from "@/app/schoolmanagement/(auth)/apps/pos-system/components/add-product-dialog";
import ProductCategoryListItem from "@/app/schoolmanagement/(auth)/apps/pos-system/components/product-category-list-item";
import { ScrollArea, ScrollBar } from "@/components/ui/scroll-area";
import POStSystemCart from "@/app/schoolmanagement/(auth)/apps/pos-system/components/cart";
import AssignOrderToTable from "@/app/schoolmanagement/(auth)/apps/pos-system/components/assign-order-to-table";
import POStSystemCartSheet from "@/app/schoolmanagement/(auth)/apps/pos-system/components/cart-sheet";
          ...
          <div className="flex justify-between lg:mb-4">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" asChild>
                <Link href="/schoolmanagement/apps/pos-system/tables">
                  <FileEdit />
