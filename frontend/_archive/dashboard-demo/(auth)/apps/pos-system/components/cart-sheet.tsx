...
import { useStore } from "@/app/schoolmanagement/(auth)/apps/pos-system/store";

import { Card, CardContent } from "@/components/ui/card";
import CartListItem from "@/app/schoolmanagement/(auth)/apps/pos-system/components/cart-list-item";
