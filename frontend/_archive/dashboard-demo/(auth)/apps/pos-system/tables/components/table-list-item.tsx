...
import { useStore, Table } from "@/app/schoolmanagement/(auth)/apps/pos-system/store";
import {
  EnumTableStatus,
  EnumTableStatusColor
} from "@/app/schoolmanagement/(auth)/apps/pos-system/enums";

import { Badge } from "@/components/ui/badge";
import TableDetailDialog from "@/app/schoolmanagement/(auth)/apps/pos-system/tables/components/table-detail-dialog";
