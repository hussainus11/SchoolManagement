...
import { Table, TableCategory } from "@/app/schoolmanagement/(auth)/apps/pos-system/store";

import { Button } from "@/components/ui/button";
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";
import TableListItem from "@/app/schoolmanagement/(auth)/apps/pos-system/tables/components/table-list-item";
import AddTableDialog from "@/app/schoolmanagement/(auth)/apps/pos-system/tables/components/add-table-dialog";
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Button variant="outline" asChild>
                        <Link href="/schoolmanagement/apps/pos-system">
                          <ChevronLeft />
                        </Link>
                      </Button>
                    </TooltipTrigger>
