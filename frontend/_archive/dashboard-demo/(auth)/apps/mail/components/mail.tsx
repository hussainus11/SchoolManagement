...
import { NavDesktop } from "@/app/schoolmanagement/(auth)/apps/mail/components/nav-desktop";
import { NavMobile } from "@/app/schoolmanagement/(auth)/apps/mail/components/nav-mobile";
import { MailDisplayMobile } from "@/app/schoolmanagement/(auth)/apps/mail/components/mail-display-mobile";
