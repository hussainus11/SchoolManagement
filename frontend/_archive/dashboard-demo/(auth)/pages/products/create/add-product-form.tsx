...
import { AddMediaFromUrl } from "@/app/schoolmanagement/(auth)/pages/products/create/add-media-from-url";
import AddNewCategory from "@/app/schoolmanagement/(auth)/pages/products/create/add-category";
        ...
        <div className="mb-4 flex flex-col justify-between space-y-4 lg:flex-row lg:items-center lg:space-y-2">
          <div className="flex items-center gap-4">
            <Button variant="outline" asChild>
              <Link href="/schoolmanagement/pages/products">
                <ChevronLeft />
              </Link>
            </Button>
